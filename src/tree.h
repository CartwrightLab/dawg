...
public:
	...
	typedef std::vector<Residue> RawData; 
	typedef std::vector<RawData> RawDataStore;
	
	class Part
	{
	public:
		typedef unsigned int color_type;
		typedef RawData::value_type value_type;
		typedef RawData::iterator iterator;
		typedef RawData::const_iterator const_iterator;
		typedef RawData::size_type size_type;
