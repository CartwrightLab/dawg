...
{
      18,     0,    -1,    -1,    18,    19,    -1,     8,    -1,     9,
       7,    21,    -1,    20,     5,     4,    -1,     4,    -1,    22,
      -1,     3,    -1,    10,    -1,    20,    -1,    25,    -1,    12,
      23,    13,    -1,    23,    21,    -1,    21,    -1,     6,    -1,
      26,    -1,    14,    27,    15,    24,    11,     3,    -1,    14,
      27,    15,    24,    -1,    14,    27,    15,    11,     3,    -1,
      14,    27,    15,    -1,    24,    11,     3,    -1,    24,    -1,
      27,    26,    -1,    26,    -1
};
...
{
  "$end", "error", "$undefined", "NUM", "STRING", "DOT", "LABEL", "EQ", 
  "END", "ID", "BOOL", "COLON", "LBRACE", "RBRACE", "LPARTH", "RPARTH", 
  "UNKNOWN", "$accept", "input", "statement", "str", "dvar", "vvector", 
  "vseq", "label", "tree", "node", "nodeseq", 0
};
#endif
...
{
       2,     0,     1,     4,     0,     3,     0,     9,     7,    16,
      10,     0,     0,    11,     5,     8,    23,    12,    17,    15,
       0,    25,     0,     0,     0,    13,    14,    21,    24,     6,
      22,     0,    19,    20,     0,    18
};
...
{
      -6,    17,    -6,    -6,    -5,    -6,     2,    -6,    -6,    -6,
      -6,     2,    15,    -1,    -6,    -6,     7,    -6,    -6,    -6,
      -3,    -6,    13,    16,    19,    -6,    -6,    24,    -6,    -6,
      -6,    28,    21,    -6,    30,    -6
};
...
{
       7,     8,     6,     9,    23,     7,     8,    10,     9,    11,
      25,    12,    10,    21,    11,    19,    12,     2,    24,     9,
      29,     9,    30,    28,    26,     3,     4,    12,    27,    12,
       9,    33,    34,    35,     0,    31,    32
};
...
static const yysigned_char yycheck[] =
{
      ...
      13,    14,    10,    12,    12,    11,    14,     0,    11,     6,
       4,     6,     3,    22,    20,     8,     9,    14,    15,    14,
       6,     3,    11,     3,    -1,    11,    27
};
...
{
       0,    18,     0,     8,     9,    19,     7,     3,     4,     6,
      10,    12,    14,    20,    21,    22,    24,    25,    26,    21,
      23,    26,    27,     5,    11,    13,    21,    15,    26,     4,
       3,    11,    24,     3,    11,     3
};
