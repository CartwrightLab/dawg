...
goldenRetriever.addModelArgument(name='Noncoding2',
    ...
    root_segment=4,
    output_rna=True)
goldenRetriever.addModelArgument(name='polypeptides',
    tree="(G:0.334, H:0.443)I;",
    substitution_model='aagtr',
    substitution_params='100.443, 49.3113, 66.3, 10.2, 40.888, 3.6520, 49.9112, 22.3323, 48.2998, 33.7171, \
    ...
    100.443, 49.3113, 66.3, 10.2, 40.888, 3.6520, 49.9112, 22.3323, 48.2998, 33.7171, \
    100.443, 49.3113, 66.3, 10.2, 40.888, 3.6520, 49.9112, 22.3323, 48.2998, 33.7171',
    substitution_freqs='0.443, 0.3113, 0.3, 0.2, 0.888, 0.6520, \
    0.9112, 0.3323, 0.2998, 0.7171, 0.443, 0.3113, 0.3003, 0.211, \
    0.5588, 0.43520, 0.487112, 0.76323, 0.1998, 0.44171',
    substitution_rate_model='zero',
    root_length=40,
    root_segment=5)
